...
; -- Subquery in WHERE (noncorrelated)
...
where exists
	...
	and line.p_code = product.p_code) -- line comes from outer query
; -- Subquery in WHERE (correlated)

-- Orders of Products 
select line.inv_number, line.line_units, line.line_price, product.p_descript
from line, product
where exists
	(select product.p_code
	from product
