...
SELECT * FROM CUSTOMER ORDER BY CUS_CODE;
SELECT * FROM INVOICE ORDER BY CUS_CODE;

-- Natural, Implicit Join
SELECT CUSTOMER.CUS_CODE, INVOICE.CUS_CODE, INVOICE.INV_NUMBER
...
SELECT * 
FROM CUSTOMER, INVOICE
ORDER BY CUSTOMER.CUS_CODE, INVOICE.CUS_CODE
;

-- Self Join
SELECT PROD1.P_DESCRIPT, PROD1.P_PRICE, PROD2.P_DESCRIPT, PROD2.P_PRICE
FROM PRODUCT AS PROD1
JOIN PRODUCT AS PROD2
ON PROD1.P_PRICE > ( PROD2.P_PRICE + 50.00 )
;

-- Implicit five-table join
